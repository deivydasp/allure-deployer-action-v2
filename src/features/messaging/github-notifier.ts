...
export class GitHubNotifier implements Notifier {
    ...
    async notify(data: NotificationData): Promise<void> {
        ...
        const logo = `<img src="https://raw.githubusercontent.com/deivydasp/allure-deployer-action-v2/master/assets/allure-logo.svg" width="18" height="18" alt="Allure" align="absmiddle">`;
        let message = '';
        if (data.reportUrl) {
