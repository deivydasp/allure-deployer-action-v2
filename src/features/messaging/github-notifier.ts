...
export class GitHubNotifier implements Notifier {
    ...
    async notify(data: NotificationData): Promise<void> {
        ...
        const logo = `<img src="https://raw.githubusercontent.com/deivydasp/allure-deployer-action-v2/master/assets/allure-logo.svg" width="20" height="20" alt="Allure" align="baseline">`;
        let message = '';
        if (data.reportUrl) {
